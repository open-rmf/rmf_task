...
breathe_projects = {
    'rmf_task': '_build/doxygen/xml'
}
breathe_default_project = 'rmf_task'

exhale_args = {
    'containmentFolder': './api',
    'rootFileName': 'rmf_task_root.rst',
    'rootFileTitle': 'rmf_task API',
    'doxygenStripFromPath': '../..',
    'createTreeView': True,
    'exhaleExecutesDoxygen': False,
    'exhaleDoxygenStdin': 'INPUT = ../rmf_task/include',
}
